...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        amberc: {
            ...
            all: {
                src: [
                    'src/Devdays.st', // list all sources in dependency order
		    'src/DripfeedIt.st',
                    'src/Devdays-Tests.st' // list all tests in dependency order
                ],
                amd_namespace: 'amber-devdays',
                libraries: ['SUnit', 'Web']
            },
            test_runner: {
                ...
                libraries: [
                    ...
                    'Devdays', /* add other code-to-test packages here */
                    'SUnit',
                    'Devdays-Tests' /* add other test packages here */
                ],
